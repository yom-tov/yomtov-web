  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-start justify-between">
        <div
          className={`grid ${size === "lg" ? "h-14 w-14" : "h-12 w-12"} place-items-center rounded-2xl bg-gradient-to-br ${subject.color} text-white shadow-md transition-transform duration-300 ease-out group-hover:rotate-6 group-hover:scale-110`}
        >
