...
function changeStyle(styleIndex, init) {
    ...
    // document.getElementById("stylesheet").href = "calc.css"
    // if (compMode != "webV") {
...
function closePal() {
    jQuery('.ads_sidebar_200').css('margin-top', '0px');
    jQuery('#ecalcBody').css('width', '665px');
    activeInput = 'ecalc_stack0';
    if (dfState == 'true') {
        toggle_df();
    }
...
function openPal() {
    jQuery('.ads_sidebar_200').css('margin-top', '630px');
    jQuery('#ecalcBody').css('width', '100%');
    if (mio) {
        document.getElementById('palette_wrap').style.display = "block";
        mio_autoShape_apply();
